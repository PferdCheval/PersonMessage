...
<form id="friend" action="friends/friends_upInfo" method="post">
修改好友信息
<table width="25%" border="1" align="center" class="font">

    <tr>
      <td align="center">
      <s:label name="friend.friendid" label="编   号"  style="color:gray;"/>
      <s:hidden name="friend.friendid"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" align="center" class="font" >
     	 <input type="submit" value="保存" onclick="return check_friend(friend);"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="重置"/>
