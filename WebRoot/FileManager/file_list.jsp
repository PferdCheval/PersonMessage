...
<s:if test="al.size>0">
<table border="5"  bgcolor="#95BDFF" width="64%" align="center">
  <tr>
...
<center>
        ...
        第&nbsp;<s:property value="pageNow"/>&nbsp;页&nbsp;&nbsp;
         <s:url var="url_pre" value="files/files_list">   
         <s:param name="pageNow" value="pageNow-1"></s:param>  
     </s:url>   
  
     <s:url var="url_next" value="files/files_list">   
         <s:param name="pageNow" value="pageNow+1"></s:param>  
     </s:url>   
     <s:iterator value="al" status="status">   
        <s:url var="url" value="files/files_list">   
